...
/**
 * 1.最终在TaskManager上面进行运行
 * 2.Listener 主要是当完成checkPoint的时候，用来发生动作
 */
public class Task implements Runnable, TaskActions, CheckpointListener {
	...
	public void run() {
		...
		try {
			...
			/** 调用用户类加载器 反射得到AbstractInvokeable的代码 */
	...
	public void triggerCheckpointBarrier(
		...
		/** 反射得到involable*/
		final AbstractInvokable invokable = this.invokable;
		/** checkpointID自增，checkpointTimestamp checkpoint的时间 */
		/** CheckPointMetaData 就是一个checkpoint的ID号 以及checkPoint的时间 */
