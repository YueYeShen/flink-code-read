 ...
 */
/**
  * client 直接提交作业到JobManager,以JobGraph的方式提交到JobManager
  * */
class JobManager(
  ...
  override def handleMessage: Receive = {
    ...
    case msg: ReconnectResourceManager =>
      ...
      /** TaskManager 发送JobManager actor消息 */
    ...
    /** 客户端发送actor消息 ,listeningBehaviour为客户端的监听模式 */
    /** *
